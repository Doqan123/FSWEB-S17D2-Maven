...
public class DeveloperController {
    ...
    public void init(){
        ...
        this.developers.put(1, new SeniorDeveloper(1, "İbrahim", 1000d));
    }
    ...
    public DeveloperResponse save(@RequestBody Developer developer){
       ...
       return new DeveloperResponse(createdDeveloper, HttpStatus.CREATED.value(), "Developer is created" );
    }
    ...
    public DeveloperResponse getById(@PathVariable("id") int id){
        ...
        if(foundDeveloper == null ){
            return new DeveloperResponse(null, HttpStatus.NOT_FOUND.value(), id + "Not Found");
        }
        return new DeveloperResponse(foundDeveloper, HttpStatus.OK.value(), "ID is found");
    }
    ...
    public DeveloperResponse update(@PathVariable("id") int id, @RequestBody Developer developer ){
        ...
        return new DeveloperResponse(newDeveloper, HttpStatus.OK.value(), "Updated developer");
    }
    ...
    public DeveloperResponse delete(@PathVariable("id") int id){
        ...
        return new DeveloperResponse(removeDeveloper, HttpStatus.NO_CONTENT.value(), "Developer is deleted" );
    }
